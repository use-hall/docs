...
The channels you have enabled will be accessible on your [community site](/community-site). The community site is where people can ask questions, [search](/search) for answers, and create [posts and comments](/posts-and-comments).
...
<Steps>
  ...
  <Step title="Add sources to improve the answer engine">
   Improve [search](/search) and the [answer engine](/answer-engine) by [adding sources](/sources) of external knowledge like documentation, help centers, blog, and other public reference material.
  </Step>
</Steps>
