---
title: Members
description: Manage and view information about members in your community site
---
...
- **[Company](/companies):** we use third-party data providers to automatically identify the [company](/companies) that member belongs to using the domain of their email address. If a company cannot be determined from their email address, the company will be displayed as _Unknown_.
...
Unknown members are those who have [signed up and verified their email](/member-authentication), but have not yet completed their profile information.
