...
Posts are created by people, either directly through your [community site](/community-site) if using the [Support forum](/channels/support-forum) channel, or by syncing posts that were created in [Discord](/channels/discord) or [Slack](/channels/slack) channels.
